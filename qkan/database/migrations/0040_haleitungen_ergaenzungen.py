...
def run(dbcon: DBConnection) -> bool:
    ...
    # Projekt neu laden, um die Tabellenänderungen zu registrieren
    # project.reloadAllLayers()

    layers = project.mapLayersByName('Geometrien')         # können mehrere sein, auch wenn's nicht gewollt ist ...
    for layer in layers:
    ...
    if True:
        abmodlayers = project.mapLayersByName('Abflusstypen')
