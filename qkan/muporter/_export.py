            ...
            if self.update:
                sql = f"""
                  ...
                  ( SELECT
                      ...
                      IIF(haltungen.hoehe>20, haltungen.hoehe/1000, haltungen.hoehe) AS geometrie1, IIF(haltungen.breite>20, haltungen.breite/1000, haltungen.breite) AS geometrie2,
