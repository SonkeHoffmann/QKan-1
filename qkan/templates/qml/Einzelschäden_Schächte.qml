...
<qgis simplifyAlgorithm="0" readOnly="0" simplifyDrawingHints="0" maxScale="0" minScale="100000000" labelsEnabled="1" simplifyDrawingTol="1" simplifyLocal="1" symbologyReferenceScale="-1" version="3.34.7-Prizren" styleCategories="AllStyleCategories" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0">
  <flags>
  ...
  <temporal fixedDuration="0" startField="" enabled="0" startExpression="to_date(&quot;untersuchtag&quot;)" mode="4" accumulate="0" limitMode="0" durationUnit="min" endField="" endExpression="to_date(&quot;untersuchtag&quot;)" durationField="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation binding="Centroid" symbology="Line" type="IndividualFeatures" respectLayerSymbol="1" extrusion="0" zoffset="0" clamping="Terrain" extrusionEnabled="0" showMarkerSymbolInSurfacePlots="0" zscale="1">
    ...
    <profileLineSymbol>
      <symbol type="line" clip_to_extent="1" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="">
        ...
        <layer locked="0" enabled="1" pass="0" id="{e4bf2692-7335-4a06-9aa1-b21c7a73b727}" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol type="fill" clip_to_extent="1" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" enabled="1" pass="0" id="{faacfd6c-9bb2-4112-b56b-92d9a0b9d830}" class="SimpleFill">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol type="marker" clip_to_extent="1" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" enabled="1" pass="0" id="{217aefc4-885f-400d-8416-6681995bfeb5}" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 type="RuleRenderer" symbollevels="0" forceraster="0" enableorderby="0" referencescale="-1">
    <rules key="{4c108ca8-1203-477a-9f48-96d4e381b74c}">
      <rule symbol="0" filter="min(ZD, ZB, ZS) = 0" key="{14f6fa52-828b-4173-9779-a734185c7d50}" label="Zustandsklasse 0, starker Mangel, Gefahr im Verzug"/>
      <rule symbol="1" filter="min(ZD, ZB, ZS) = 1" key="{7d940636-afec-4238-8412-8e5bd6db260b}" label="Zustandsklasse 1, starker Mangel"/>
      <rule symbol="2" filter="min(ZD, ZB, ZS) = 2" key="{9c39bafb-a521-44a9-a29e-0fb200ff73c2}" label="Zustandsklasse 2, mittlerer Mangel"/>
      <rule symbol="3" filter="min(ZD, ZB, ZS) = 3" key="{dbe7c6f4-43a6-47c8-8dd3-f4d395b62016}" label="Zustandsklasse 3, leichter Mangel"/>
      <rule symbol="4" filter="min(ZD, ZB, ZS) = 4" key="{857733ab-acb9-405b-aa85-9270d8a95091}" label="Zustandsklasse 4, geringfügiger Mangel"/>
      <rule symbol="5" filter="min(ZD, ZB, ZS) = 5" key="{a5aced04-09fd-409a-9f4b-ca71ca17d7bd}" label="Zustandsklasse 5, kein Mangel"/>
      <rule symbol="6" filter="(min(ZD, ZB, ZS) &lt; 1 OR min(ZD, ZB, ZS) > 5)" key="{06fa0df9-3a60-4a3c-a72c-ca8f10d3ad45}" label="nicht ermittelt"/>
    </rules>
    <symbols>
      <symbol type="line" clip_to_extent="1" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" enabled="1" pass="0" id="{3394e3a4-41c5-4f7c-b015-7036d606a030}" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
      ...
      <symbol type="line" clip_to_extent="1" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" enabled="1" pass="0" id="{72f55a27-3c06-45cd-b5b2-79e49bd2ce2c}" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
      ...
      <symbol type="line" clip_to_extent="1" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="2">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" enabled="1" pass="0" id="{4c71962e-0a5b-4aa1-b0c3-3aa501da6217}" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
      ...
      <symbol type="line" clip_to_extent="1" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="3">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" enabled="1" pass="0" id="{7c34887f-db2c-45c3-8b28-ac86ac6eb017}" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
      ...
      <symbol type="line" clip_to_extent="1" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="4">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" enabled="1" pass="0" id="{2ec40cc6-f822-442e-bc68-770108f70ba0}" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
      ...
      <symbol type="line" clip_to_extent="1" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="5">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" enabled="1" pass="0" id="{4e6e7b9a-f13f-4b87-8719-a207fb1b1e1f}" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
      ...
      <symbol type="line" clip_to_extent="1" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="6">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" enabled="1" pass="0" id="{a6f0349f-8e6b-46cd-900a-62a15f90db37}" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="line" clip_to_extent="1" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="">
        ...
        <layer locked="0" enabled="1" pass="0" id="{6c3f8b5a-ca66-4b28-b1d6-b16932f48894}" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style forcedBold="0" isExpression="1" forcedItalic="0" fontWordSpacing="0" fontLetterSpacing="0" fontSize="0.25" fieldName="kuerzel+ ' ' + left(coalesce(charakt1, ' ') + ' ', 1) + ' ' + left(coalesce(charakt2, ' ') + ' ', 1)" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" fontWeight="50" useSubstitutions="0" fontItalic="0" fontStrikeout="0" namedStyle="Standard" fontSizeUnit="RenderMetersInMapUnits" fontFamily="Arial" capitalization="0" legendString="Aa" fontKerning="1" multilineHeight="1" blendMode="0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" textColor="0,0,0,255" multilineHeightUnit="Percentage" textOpacity="1" allowHtml="0">
        <families/>
        <text-buffer bufferOpacity="1" bufferNoFill="1" bufferBlendMode="0" bufferDraw="0" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferJoinStyle="128"/>
        <text-mask maskType="0" maskSizeUnits="MM" maskOpacity="1" maskSize="0.5" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskEnabled="0" maskJoinStyle="128" maskedSymbolLayers=""/>
        <background shapeRadiiX="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeSizeType="0" shapeRotation="0" shapeSVGFile="" shapeBorderColor="128,128,128,255" shapeSizeX="0.29999999999999999" shapeOpacity="1" shapeFillColor="255,255,255,255" shapeDraw="1" shapeRotationType="0" shapeRadiiUnit="MM" shapeBorderWidth="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="RenderMetersInMapUnits" shapeType="0" shapeBlendMode="0" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeRadiiY="0" shapeOffsetUnit="MM" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0.01">
          <symbol type="marker" clip_to_extent="1" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="markerSymbol">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
          ...
          <symbol type="fill" clip_to_extent="1" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="fillSymbol">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
        ...
        <shadow shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowRadiusUnit="MM" shadowBlendMode="6" shadowUnder="0" shadowOffsetGlobal="1" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowOpacity="0" shadowColor="0,0,0,255" shadowOffsetAngle="135" shadowDraw="0" shadowRadiusAlphaOnly="0" shadowOffsetDist="1" shadowOffsetUnit="MM" shadowScale="100" shadowRadius="0"/>
        <dd_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
      ...
      <text-format addDirectionSymbol="0" rightDirectionSymbol=">" autoWrapLength="0" formatNumbers="0" plussign="0" wrapChar="" leftDirectionSymbol="&lt;" useMaxLineLengthForAutoWrap="1" multilineAlign="0" reverseDirectionSymbol="0" placeDirectionSymbol="0" decimals="3"/>
      <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overlapHandling="AllowOverlapIfRequired" repeatDistanceUnits="MM" placementFlags="9" placement="2" dist="0" overrunDistanceUnit="MM" distUnits="MM" preserveRotation="1" repeatDistance="0" maxCurvedCharAngleOut="-25" quadOffset="4" lineAnchorType="1" allowDegraded="1" xOffset="0" lineAnchorClipping="1" yOffset="0" geometryGeneratorEnabled="0" layerType="LineGeometry" offsetType="0" maxCurvedCharAngleIn="25" polygonPlacementFlags="2" geometryGenerator="" centroidInside="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" fitInPolygonOnly="0" lineAnchorTextPoint="CenterOfText" distMapUnitScale="3x:0,0,0,0,0,0" priority="5" rotationUnit="AngleDegrees" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" rotationAngle="0" offsetUnits="MM" geometryGeneratorType="PointGeometry" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="1"/>
      <rendering obstacleFactor="1" labelPerPart="0" minFeatureSize="0" fontMinPixelSize="3" scaleMin="1" drawLabels="1" mergeLines="0" zIndex="0" maxNumLabels="2000" scaleVisibility="1" scaleMax="2500" obstacle="0" fontMaxPixelSize="10000" unplacedVisibility="0" limitNumLabels="0" obstacleType="1" fontLimitPixelSize="0" upsidedownLabels="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" value="" name="name"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory sizeType="MM" showAxis="1" minimumSize="0" backgroundAlpha="255" rotationOffset="270" penWidth="0" spacing="5" opacity="1" spacingUnit="MM" labelPlacementMethod="XHeight" maxScaleDenominator="1e+08" scaleDependency="Area" enabled="0" lineSizeType="MM" barWidth="5" spacingUnitScale="3x:0,0,0,0,0,0" direction="0" scaleBasedVisibility="0" penColor="#000000" penAlpha="255" width="15" sizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" backgroundColor="#ffffff" diagramOrientation="Up" lineSizeScale="3x:0,0,0,0,0,0" height="15">
      <fontProperties style="" italic="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" bold="0"/>
      ...
      <axisSymbol>
        <symbol type="line" clip_to_extent="1" frame_rate="10" force_rhr="0" is_animated="0" alpha="1" name="">
          ...
          <layer locked="0" enabled="1" pass="0" id="{d48aa403-98db-4768-a59b-7b438a18c18a}" class="SimpleLine">
            <Option type="Map">
              <Option type="QString" value="0" name="align_dash_pattern"/>
              <Option type="QString" value="square" name="capstyle"/>
              <Option type="QString" value="5;2" name="customdash"/>
  ...
  <DiagramLayerSettings showAll="1" priority="0" placement="2" zIndex="0" linePlacementFlags="18" obstacle="0" dist="0">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <constraints>
    <constraint unique_strength="1" exp_strength="0" field="pk" constraints="3" notnull_strength="1"/>
    <constraint unique_strength="0" exp_strength="0" field="untersuchsch" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="id" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="untersuchtag" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="bandnr" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="videozaehler" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="timecode" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="langtext" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="kuerzel" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="charakt1" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="charakt2" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="quantnr1" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="quantnr2" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="streckenschaden" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="streckenschaden_lfdnr" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="pos_von" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="pos_bis" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="vertikale_lage" constraints="0" notnull_strength="0"/>
    ...
    <constraint unique_strength="0" exp_strength="0" field="video_start" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="video_ende" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="ZD" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="ZB" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="ZS" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="kommentar" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" exp_strength="0" field="createdat" constraints="0" notnull_strength="0"/>
  </constraints>
  ...
  <expressionfields/>
  <attributeactions>
    <defaultAction key="Canvas" value="{3d54d528-fe05-4027-8c24-c00bab9a5282}"/>
    <actionsetting type="5" action="[%foto_dateiname%]" notificationMessage="" isEnabledOnlyWhenEditable="0" id="{bb35f5ca-7e7f-44b7-bfaa-ffea0d960666}" shortTitle="Bild öffnen" icon="" capture="0" name="Bild öffnen">
      <actionScope id="Feature"/>
      <actionScope id="Canvas"/>
    </actionsetting>
    <actionsetting type="1" action="from qgis.utils import iface&#xa;from qgis.core import *&#xa;from qgis.gui import QgsMessageBar&#xd;&#xa;import os&#xa;&#xa;try:&#xa;    from qkan.tools.videoplayer import Videoplayer&#xa;&#xd;&#xa;    video=r'[%film_dateiname%]'&#xd;&#xa;    video=video.lower()&#xd;&#xa;    #timecode=[% if(&quot;timecode&quot; = NULL,None,&quot;timecode&quot;)%]&#xd;&#xa;    timecode = None&#xd;&#xa;    timecode=[%CASE WHEN &quot;timecode&quot;  IS NULL THEN 0 ELSE &quot;timecode&quot; END%]&#xd;&#xa;    if timecode == 0:&#xd;&#xa;        window = Videoplayer(video=video, time=0)&#xa;    else:&#xd;&#xa;        time_h=int(timecode/1000000) if timecode>1000000 else 0&#xd;&#xa;        time_m=(int(timecode/10000) if timecode>10000 else 0 )-(time_h*100)&#xd;&#xa;        time_s=(int(timecode/100) if timecode>100 else 0 )-(time_h*10000)-(time_m*100)&#xd;&#xa;        &#xd;&#xa;        video_offset= [%CASE WHEN &quot;video_offset&quot;  IS NULL THEN 0 ELSE &quot;video_offset&quot; END%]&#xd;&#xa;        time = float(time_h/3600+time_m/60+time_s+video_offset)&#xd;&#xa;        window = Videoplayer(video=video, time=time)&#xd;&#xa;        &#xd;&#xa;    window.show()&#xa;    window.open_file()&#xa;    window.exec_()&#xa;        &#xa;except ImportError:&#xa;    raise Exception(&#xa;        &quot;The QKan main plugin has to be installed for this to work.&quot;&#xa;     )&#xa;" notificationMessage="" isEnabledOnlyWhenEditable="0" id="{3a3384dc-9a4e-4d34-909c-74537cee71fa}" shortTitle="Video abspielen" icon="" capture="0" name="Video abspielen">
      <actionScope id="Feature"/>
      <actionScope id="Canvas"/>
    </actionsetting>
    <actionsetting type="1" action="from qkan.tools.zeige_untersuchungsdaten import ShowSchachtschaeden&#xd;&#xa;&#xd;&#xa;form = ShowSchachtschaeden('[%untersuchsch%]')&#xd;&#xa;form.show_selected()&#xd;&#xa;del form&#xd;&#xa;" notificationMessage="" isEnabledOnlyWhenEditable="0" id="{7a5bc868-254a-45ab-a059-1ef3bf749701}" shortTitle="" icon="" capture="0" name="Zustandsdaten für alle Schächte anzeigen">
      <actionScope id="Feature"/>
      <actionScope id="Canvas"/>
    </actionsetting>
    <actionsetting type="1" action="from qkan.tools.zeige_untersuchungsdaten import ShowSchachtschaeden&#xd;&#xa;&#xd;&#xa;form = ShowSchachtschaeden('[%untersuchsch%]', '[%untersuchtag%]')&#xd;&#xa;form.show_selected()&#xd;&#xa;del form&#xd;&#xa;" notificationMessage="" isEnabledOnlyWhenEditable="0" id="{3d54d528-fe05-4027-8c24-c00bab9a5282}" shortTitle="" icon="" capture="0" name="Zustandsdaten für einen Schacht anzeigen">
      <actionScope id="Feature"/>
      <actionScope id="Canvas"/>
    </actionsetting>
  </attributeactions>
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column type="field" hidden="0" width="-1" name="untersuchsch"/>
      <column type="field" hidden="0" width="-1" name="id"/>
      <column type="field" hidden="0" width="-1" name="untersuchtag"/>
      <column type="field" hidden="0" width="-1" name="bandnr"/>
      <column type="field" hidden="0" width="-1" name="videozaehler"/>
      <column type="field" hidden="0" width="-1" name="timecode"/>
      <column type="field" hidden="0" width="-1" name="langtext"/>
      <column type="field" hidden="0" width="-1" name="kuerzel"/>
      <column type="field" hidden="0" width="-1" name="charakt1"/>
      <column type="field" hidden="0" width="-1" name="charakt2"/>
      <column type="field" hidden="0" width="-1" name="quantnr1"/>
      <column type="field" hidden="0" width="-1" name="quantnr2"/>
      <column type="field" hidden="0" width="-1" name="streckenschaden"/>
      <column type="field" hidden="0" width="-1" name="streckenschaden_lfdnr"/>
      <column type="field" hidden="0" width="-1" name="pos_von"/>
      <column type="field" hidden="0" width="-1" name="pos_bis"/>
      <column type="field" hidden="0" width="-1" name="vertikale_lage"/>
      ...
      <column type="field" hidden="0" width="-1" name="video_start"/>
      <column type="field" hidden="0" width="-1" name="video_ende"/>
      <column type="field" hidden="0" width="-1" name="ZD"/>
      <column type="field" hidden="0" width="-1" name="ZB"/>
      <column type="field" hidden="0" width="-1" name="ZS"/>
