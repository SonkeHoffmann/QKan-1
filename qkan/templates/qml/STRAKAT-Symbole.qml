...
<qgis maxScale="0" readOnly="0" version="3.28.15-Firenze" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|AttributeTable|Rendering|CustomProperties|Relations|Temporal|Legend|Notes" simplifyDrawingTol="1" minScale="100000000" simplifyLocal="1" simplifyMaxScale="1" symbologyReferenceScale="-1" simplifyDrawingHints="0">
  <flags>
  ...
  <temporal startField="" endField="" accumulate="0" enabled="0" durationField="pk" durationUnit="min" mode="0" limitMode="0" endExpression="" startExpression="" fixedDuration="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <renderer-v2 attr="art" type="categorizedSymbol" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <categories>
      <category value="Strassenablauf" symbol="0" label="Strassenablauf" type="string" render="true"/>
      <category value="Strasseneinlauf" symbol="1" label="Strasseneinlauf" type="string" render="true"/>
      <category value="" symbol="2" label="" type="string" render="true"/>
    </categories>
    <symbols>
      <symbol force_rhr="0" clip_to_extent="1" name="0" is_animated="0" type="marker" alpha="1" frame_rate="10">
      ...
      <symbol force_rhr="0" clip_to_extent="1" name="1" is_animated="0" type="marker" alpha="1" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol force_rhr="0" clip_to_extent="1" name="2" is_animated="0" type="marker" alpha="1" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="dbname='bruehl.sqlite' table=&quot;symbolkatalog&quot;" name="LayerSource" type="QString"/>
  ...
  <aliases>
    ...
    <alias name="Bezeichnung" field="bezeichnung" index="1"/>
    <alias name="Symbolart" field="art" index="2"/>
    <alias name="Verknüpfung" field="link" index="3"/>
    <alias name="" field="gruppe" index="4"/>
    <alias name="Kommentar" field="kommentar" index="5"/>
    <alias name="erstellt" field="createdat" index="6"/>
  </aliases>
  <defaults>
    <default field="pk" expression="" applyOnUpdate="0"/>
    <default field="bezeichnung" expression="" applyOnUpdate="0"/>
    <default field="art" expression="'Sonstige'" applyOnUpdate="0"/>
    <default field="link" expression="" applyOnUpdate="0"/>
    <default field="gruppe" expression="'Entwässerung'" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" unique_strength="0" field="art" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" unique_strength="0" field="link" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" field="gruppe" exp=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      <column name="pk" type="field" width="147" hidden="0"/>
      ...
      <column name="gruppe" type="field" width="-1" hidden="0"/>
