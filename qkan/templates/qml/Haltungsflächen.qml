...
<qgis styleCategories="AllStyleCategories" maxScale="0" minScale="0" labelsEnabled="0" simplifyLocal="1" simplifyAlgorithm="0" readOnly="0" version="3.28.13-Firenze" simplifyDrawingHints="1" symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyMaxScale="1">
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory backgroundAlpha="255" spacingUnitScale="3x:0,0,0,0,0,0" width="15" spacingUnit="MM" minimumSize="0" penColor="#000000" sizeScale="3x:0,0,0,0,0,0" spacing="5" penWidth="0" diagramOrientation="Up" penAlpha="255" showAxis="1" height="15" labelPlacementMethod="XHeight" opacity="1" backgroundColor="#ffffff" sizeType="MM" rotationOffset="270" lineSizeType="MM" scaleBasedVisibility="0" lineSizeScale="3x:0,0,0,0,0,0" enabled="0" maxScaleDenominator="0" scaleDependency="Area" direction="0" barWidth="5" minScaleDenominator="0">
      <fontProperties strikethrough="0" italic="0" description="MS Shell Dlg 2,5.5,-1,5,50,0,0,0,0,0" style="" bold="0" underline="0"/>
  ...
  <constraints>
    ...
    <constraint field="befgrad" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="schwerpunktlaufzeit" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
