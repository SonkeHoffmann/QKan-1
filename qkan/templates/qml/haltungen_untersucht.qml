...
<qgis simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" maxScale="0" simplifyDrawingTol="1" readOnly="0" simplifyLocal="1" version="3.34.7-Prizren" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" minScale="100000000" simplifyMaxScale="1" simplifyAlgorithm="0">
  <flags>
  ...
  <elevation extrusion="0" zscale="1" symbology="Line" respectLayerSymbol="1" zoffset="0" binding="Centroid" type="IndividualFeatures" extrusionEnabled="0" showMarkerSymbolInSurfacePlots="0" clamping="Terrain">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" type="line" clip_to_extent="1" name="" force_rhr="0" alpha="1" frame_rate="10">
        ...
        <layer pass="0" id="{75b2b4a7-ce5b-4338-bfe0-b53b8dac914d}" class="SimpleLine" locked="0" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" type="fill" clip_to_extent="1" name="" force_rhr="0" alpha="1" frame_rate="10">
        ...
        <layer pass="0" id="{69fb6b06-6631-468f-9340-c7a6480962d0}" class="SimpleFill" locked="0" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" type="marker" clip_to_extent="1" name="" force_rhr="0" alpha="1" frame_rate="10">
        ...
        <layer pass="0" id="{56e2a462-b055-4c58-8426-50ef190b0a30}" class="SimpleMarker" locked="0" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 referencescale="-1" enableorderby="0" type="categorizedSymbol" symbollevels="0" attr="min(max_ZD, max_ZB, max_ZS)" forceraster="0">
    <categories>
      <category symbol="0" type="string" value="0" label="Zustandsklasse 0, starker Mangel, Gefahr in Verzug" render="true" uuid="0"/>
      <category symbol="1" type="string" value="1" label="Zustandsklasse 1, starker Mangel" render="true" uuid="1"/>
      <category symbol="2" type="string" value="2" label="Zustandsklasse 2, mittlerer Mangel" render="true" uuid="2"/>
      <category symbol="3" type="string" value="3" label="Zustandsklasse 3, leichter Mangel" render="true" uuid="3"/>
      <category symbol="4" type="string" value="4" label="Zustandsklasse 4, geringfügiger Mangel" render="true" uuid="4"/>
      <category symbol="5" type="string" value="5" label="Zustandsklasse 5, kein Mangel" render="true" uuid="5"/>
      <category symbol="6" type="string" value="" label="nicht ermittelt" render="true" uuid="6"/>
    </categories>
    <symbols>
      <symbol is_animated="0" type="line" clip_to_extent="1" name="0" force_rhr="0" alpha="1" frame_rate="10">
        ...
        <layer pass="0" id="{9c125117-cd19-4b7a-a869-f800c4c9a2bc}" class="SimpleLine" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
            ...
            <Option type="QString" value="0" name="draw_inside_polygon"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="255,21,21,255" name="line_color"/>
            <Option type="QString" value="solid" name="line_style"/>
      ...
      <symbol is_animated="0" type="line" clip_to_extent="1" name="1" force_rhr="0" alpha="1" frame_rate="10">
        ...
        <layer pass="0" id="{2072cc36-c7c7-4ab0-97b1-4b730291cfa6}" class="SimpleLine" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
      ...
      <symbol is_animated="0" type="line" clip_to_extent="1" name="2" force_rhr="0" alpha="1" frame_rate="10">
        ...
        <layer pass="0" id="{0136ecc5-e3e3-41a1-bba3-577ab03c7b05}" class="SimpleLine" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
      ...
      <symbol is_animated="0" type="line" clip_to_extent="1" name="3" force_rhr="0" alpha="1" frame_rate="10">
        ...
        <layer pass="0" id="{d69436dd-03f8-462e-9a70-215d8c3c83b0}" class="SimpleLine" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
      ...
      <symbol is_animated="0" type="line" clip_to_extent="1" name="4" force_rhr="0" alpha="1" frame_rate="10">
        ...
        <layer pass="0" id="{4ae97ede-3f54-47dc-9248-2121ccce349a}" class="SimpleLine" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
      ...
      <symbol is_animated="0" type="line" clip_to_extent="1" name="5" force_rhr="0" alpha="1" frame_rate="10">
        ...
        <layer pass="0" id="{27e26651-0667-40f5-9ad7-a33c8773726b}" class="SimpleLine" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
      ...
      <symbol is_animated="0" type="line" clip_to_extent="1" name="6" force_rhr="0" alpha="1" frame_rate="10">
        ...
        <layer pass="0" id="{1a2e3706-5c87-4177-809f-d6e506a1dd10}" class="SimpleLine" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
            ...
            <Option type="QString" value="0" name="draw_inside_polygon"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="203,203,203,255" name="line_color"/>
            <Option type="QString" value="solid" name="line_style"/>
    ...
    <source-symbol>
      <symbol is_animated="0" type="line" clip_to_extent="1" name="0" force_rhr="0" alpha="1" frame_rate="10">
        ...
        <layer pass="0" id="{6bb4dd05-cc35-4f9d-aa61-709bc8e0ca1a}" class="SimpleLine" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol is_animated="0" type="line" clip_to_extent="1" name="" force_rhr="0" alpha="1" frame_rate="10">
        ...
        <layer pass="0" id="{d62754b9-38f0-4c0d-841b-df2642b7e597}" class="SimpleLine" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
    ...
    <DiagramCategory labelPlacementMethod="XHeight" minScaleDenominator="0" height="15" backgroundColor="#ffffff" scaleDependency="Area" showAxis="1" diagramOrientation="Up" spacingUnitScale="3x:0,0,0,0,0,0" barWidth="5" penAlpha="255" minimumSize="0" width="15" enabled="0" spacingUnit="MM" rotationOffset="270" sizeScale="3x:0,0,0,0,0,0" sizeType="MM" spacing="5" maxScaleDenominator="1e+08" lineSizeType="MM" backgroundAlpha="255" lineSizeScale="3x:0,0,0,0,0,0" penWidth="0" opacity="1" scaleBasedVisibility="0" direction="0" penColor="#000000">
      ...
      <axisSymbol>
        <symbol is_animated="0" type="line" clip_to_extent="1" name="" force_rhr="0" alpha="1" frame_rate="10">
          ...
          <layer pass="0" id="{c78e4506-aa23-436c-aaed-00242d8a2ded}" class="SimpleLine" locked="0" enabled="1">
            <Option type="Map">
              <Option type="QString" value="0" name="align_dash_pattern"/>
              <Option type="QString" value="square" name="capstyle"/>
              <Option type="QString" value="5;2" name="customdash"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <mapTip enabled="1">[% haltnam || ' (' || untersuchtag || ')' %]</mapTip>
