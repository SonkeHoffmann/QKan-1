...
<qgis labelsEnabled="0" version="3.28.15-Firenze" readOnly="0" styleCategories="LayerConfiguration|Symbology|Labeling|Forms|MapTips|AttributeTable|Notes">
  <flags>
  ...
  <renderer-v2 symbollevels="0" referencescale="-1" enableorderby="0" type="singleSymbol" forceraster="0">
    <symbols>
      <symbol force_rhr="0" is_animated="0" clip_to_extent="1" type="line" name="0" alpha="1" frame_rate="10">
  ...
  <attributetableconfig sortExpression="&quot;haltnam&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column type="field" name="aussendurchmesser" hidden="0" width="-1"/>
      ...
      <column type="field" name="eigentum" hidden="0" width="-1"/>
      ...
      <column type="field" name="entwart" hidden="0" width="-1"/>
      <column type="field" name="material" hidden="0" width="-1"/>
      <column type="field" name="profilauskleidung" hidden="0" width="-1"/>
      <column type="field" name="innenmaterial" hidden="0" width="-1"/>
      ...
      <column type="field" name="druckdicht" hidden="0" width="-1"/>
      <column type="field" name="kommentar" hidden="0" width="-1"/>
      <column type="field" name="createdat" hidden="0" width="-1"/>
      <column type="field" name="rwanschluss" hidden="0" width="-1"/>
