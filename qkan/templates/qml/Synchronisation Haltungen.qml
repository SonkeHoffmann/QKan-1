...
<qgis styleCategories="Symbology|Forms|AttributeTable|Notes" version="3.40.14-Bratislava">
  <renderer-v2 symbollevels="0" type="singleSymbol" enableorderby="0" referencescale="-1" forceraster="0">
    <symbols>
      <symbol clip_to_extent="1" force_rhr="0" is_animated="0" frame_rate="10" type="line" alpha="1" name="0">
        ...
        <layer id="{323dea2d-9adb-469a-8f7a-0f3f6c1d3cc0}" enabled="1" class="SimpleLine" locked="0" pass="0">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol clip_to_extent="1" force_rhr="0" is_animated="0" frame_rate="10" type="line" alpha="1" name="">
        ...
        <layer id="{1537f2e3-6aff-41d9-b42b-420cc2ca61f1}" enabled="1" class="SimpleLine" locked="0" pass="0">
          <Option type="Map">
            <Option value="0" type="QString" name="align_dash_pattern"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="&quot;haltnam&quot;">
    <columns>
      ...
      <column width="125" type="field" hidden="0" name="haltnam"/>
      ...
      <column width="-1" type="field" hidden="0" name="rwanschluss"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="0" name="aussendurchmesser"/>
    ...
    <field editable="0" name="haltungstyp"/>
    <field editable="0" name="hoehe"/>
    <field editable="0" name="innenmaterial"/>
    <field editable="0" name="kommentar"/>
    <field editable="0" name="ks"/>
    ...
    <field editable="0" name="profilauskleidung"/>
    <field editable="0" name="profilnam"/>
    <field editable="0" name="rwanschluss"/>
    <field editable="0" name="schoben"/>
    <field editable="0" name="schunten"/>
    <field editable="0" name="simstatus"/>
    <field editable="0" name="sohleoben"/>
    <field editable="0" name="sohleunten"/>
    <field editable="1" name="status"/>
    <field editable="0" name="strasse"/>
    <field editable="0" name="teilgebiet"/>
    <field editable="0" name="transport"/>
