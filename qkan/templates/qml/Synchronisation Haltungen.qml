...
<qgis simplifyAlgorithm="0" simplifyLocal="1" minScale="0" version="3.28.15-Firenze" readOnly="0" maxScale="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|AttributeTable|Rendering|CustomProperties|Notes" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyMaxScale="1" labelsEnabled="0" symbologyReferenceScale="-1">
  <flags>
  ...
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol name="0" alpha="1" is_animated="0" clip_to_extent="1" type="line" force_rhr="0" frame_rate="10">
  ...
  <aliases>
    ...
    <alias name="id_Bestand" index="1" field="pk_best"/>
    <alias name="id_extern" index="2" field="pk_ext"/>
    <alias name="Maßnahme" index="3" field="aktion"/>
    <alias name="ausführen" index="4" field="status"/>
    <alias name="Grafikobjekt" index="5" field="objekt"/>
    <alias name="Haltungsbezeichnung" index="6" field="haltnam"/>
    <alias name="Anfangsschacht" index="7" field="schoben"/>
    <alias name="Endschacht" index="8" field="schunten"/>
    <alias name="Profilhöhe" index="9" field="hoehe"/>
    <alias name="Profilbreite" index="10" field="breite"/>
    <alias name="Haltungslänge" index="11" field="laenge"/>
    <alias name="Außendurchmesser" index="12" field="aussendurchmesser"/>
    <alias name="Sohlhöhe Anfang" index="13" field="sohleoben"/>
    <alias name="Sohlhöhe Ende" index="14" field="sohleunten"/>
    <alias name="Baujahr" index="15" field="baujahr"/>
    <alias name="Eigentümer" index="16" field="eigentum"/>
    ...
    <alias name="Elementtyp" index="25" field="haltungstyp"/>
    <alias name="Planungsstatus" index="26" field="simstatus"/>
    <alias name="hat RW-Anschlüsse" index="27" field="rwanschluss"/>
    <alias name="druckdicht" index="28" field="druckdicht"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="pk_best"/>
    <default applyOnUpdate="0" expression="" field="pk_ext"/>
    <default applyOnUpdate="0" expression="" field="aktion"/>
    <default applyOnUpdate="0" expression="" field="status"/>
    <default applyOnUpdate="0" expression="" field="objekt"/>
  ...
  <constraints>
    <constraint unique_strength="1" constraints="3" notnull_strength="1" field="pk" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="pk_best" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="pk_ext" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="aktion" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="status" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="objekt" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="haltnam" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="schoben" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="schunten" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="hoehe" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="breite" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="laenge" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="aussendurchmesser" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="sohleoben" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="sohleunten" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="baujahr" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="eigentum" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="teilgebiet" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="strasse" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="profilnam" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="entwart" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="material" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="profilauskleidung" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="innenmaterial" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="ks" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="haltungstyp" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="simstatus" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="rwanschluss" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="druckdicht" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="kommentar" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" notnull_strength="0" field="createdat" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="pk" desc=""/>
    <constraint exp="" field="pk_best" desc=""/>
    <constraint exp="" field="pk_ext" desc=""/>
    <constraint exp="" field="aktion" desc=""/>
    <constraint exp="" field="status" desc=""/>
    <constraint exp="" field="objekt" desc=""/>
    ...
    <constraint exp="" field="aussendurchmesser" desc=""/>
    <constraint exp="" field="sohleoben" desc=""/>
    <constraint exp="" field="sohleunten" desc=""/>
    <constraint exp="" field="baujahr" desc=""/>
    <constraint exp="" field="eigentum" desc=""/>
    ...
    <constraint exp="" field="profilauskleidung" desc=""/>
    <constraint exp="" field="innenmaterial" desc=""/>
    <constraint exp="" field="ks" desc=""/>
    <constraint exp="" field="haltungstyp" desc=""/>
    <constraint exp="" field="simstatus" desc=""/>
    <constraint exp="" field="rwanschluss" desc=""/>
  ...
  <attributetableconfig sortExpression="&quot;haltnam&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="aktion" hidden="0" width="-1" type="field"/>
      <column name="haltnam" hidden="0" width="125" type="field"/>
      <column name="objekt" hidden="0" width="-1" type="field"/>
  ...
  <storedexpressions/>
  <editform tolerant="1">C:\Users/hoettges/AppData/Roaming/QGIS/QGIS3\profiles\default/python/plugins\qkan\forms\sync_haltungen.ui</editform>
  <editforminit/>
...
def my_form_open(dialog, layer, feature):
  ...
  <reuseLastValue>
    ...
    <field name="status" reuseLastValue="1"/>
