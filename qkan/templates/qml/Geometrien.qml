...
<qgis hasScaleBasedVisibilityFlag="0" readOnly="0" maxScale="100000" minScale="100000000" simplifyDrawingHints="0" symbologyReferenceScale="-1" simplifyDrawingTol="1" simplifyLocal="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.28.13-Firenze" simplifyMaxScale="1" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|AttributeTable|Rendering|CustomProperties|GeometryOptions|Temporal|Legend|Notes">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontKerning="1" fontUnderline="0" textOrientation="horizontal" multilineHeightUnit="Percentage" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" fontWeight="50" textOpacity="1" capitalization="0" blendMode="0" fontSize="0" fontFamily="MS Shell Dlg 2" fontLetterSpacing="0" allowHtml="0" fontStrikeout="0" textColor="51,160,44,255" fontItalic="0" fontWordSpacing="0" useSubstitutions="0" forcedBold="0" previewBkgrdColor="255,255,255,255" legendString="Aa" multilineHeight="1" fontSizeUnit="Point" forcedItalic="0" namedStyle="Standard" fieldName="schnam">
        <families/>
      ...
      <placement overlapHandling="PreventOverlap" rotationUnit="AngleDegrees" dist="1" yOffset="-1" lineAnchorPercent="0" preserveRotation="1" xOffset="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placement="2" layerType="LineGeometry" maxCurvedCharAngleOut="-20" rotationAngle="0" lineAnchorTextPoint="CenterOfText" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorType="0" overrunDistanceUnit="MM" fitInPolygonOnly="0" priority="5" polygonPlacementFlags="2" centroidInside="0" allowDegraded="0" geometryGenerator="" geometryGeneratorEnabled="0" distMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" distUnits="MM" overrunDistance="0" repeatDistanceUnits="MM" geometryGeneratorType="PointGeometry" offsetUnits="MapUnit" lineAnchorClipping="0" centroidWhole="0" repeatDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" quadOffset="2" offsetType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="20"/>
      <rendering scaleMax="250" upsidedownLabels="0" fontLimitPixelSize="0" obstacleType="0" zIndex="0" obstacleFactor="1" labelPerPart="0" scaleVisibility="1" scaleMin="1" maxNumLabels="2000" fontMaxPixelSize="10000" obstacle="1" minFeatureSize="0" unplacedVisibility="0" drawLabels="1" mergeLines="0" limitNumLabels="0" fontMinPixelSize="3"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="LayerProviderName" value="spatialite"/>
            <Option type="QString" name="LayerSource" value="dbname='demo.sqlite' table=&quot;knotentypen&quot;"/>
            <Option type="int" name="NofColumns" value="1"/>
            <Option type="bool" name="OrderByValue" value="false"/>
            <Option type="bool" name="UseCompleter" value="true"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="LayerProviderName" value="spatialite"/>
            <Option type="QString" name="LayerSource" value="dbname='demo.sqlite' table=&quot;schachttypen&quot;"/>
            <Option type="int" name="NofColumns" value="1"/>
            <Option type="bool" name="OrderByValue" value="false"/>
            <Option type="bool" name="UseCompleter" value="true"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" unique_strength="0" constraints="0" notnull_strength="0" field="sohlhoehe"/>
    <constraint exp_strength="0" unique_strength="0" constraints="0" notnull_strength="0" field="deckelhoehe"/>
    ...
    <constraint exp_strength="0" unique_strength="0" constraints="0" notnull_strength="0" field="ueberstauflaeche"/>
    ...
    <constraint exp_strength="0" unique_strength="0" constraints="0" notnull_strength="0" field="auslasstyp"/>
    <constraint exp_strength="0" unique_strength="0" constraints="0" notnull_strength="0" field="schachttyp"/>
    ...
    <constraint exp_strength="0" unique_strength="0" constraints="0" notnull_strength="0" field="xsch"/>
    <constraint exp_strength="0" unique_strength="0" constraints="0" notnull_strength="0" field="ysch"/>
    ...
    <constraint exp_strength="0" unique_strength="0" constraints="0" notnull_strength="0" field="geop"/>
    <constraint exp_strength="0" unique_strength="0" constraints="0" notnull_strength="0" field="x"/>
    <constraint exp_strength="0" unique_strength="0" constraints="0" notnull_strength="0" field="y"/>
  </constraints>
  ...
  <expressionfields>
    <field type="6" typeName="double precision" name="x" expression="x(centroid($geometry))" precision="0" length="-1" comment="" subType="0"/>
    <field type="6" typeName="double precision" name="y" expression="y(centroid($geometry))" precision="0" length="-1" comment="" subType="0"/>
  </expressionfields>
  <attributeactions>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column width="-1" type="field" name="sohlhoehe" hidden="0"/>
      <column width="-1" type="field" name="deckelhoehe" hidden="0"/>
      <column width="-1" type="field" name="durchm" hidden="0"/>
      <column width="-1" type="field" name="druckdicht" hidden="0"/>
      <column width="-1" type="field" name="ueberstauflaeche" hidden="0"/>
      ...
      <column width="-1" type="field" name="auslasstyp" hidden="0"/>
      <column width="-1" type="field" name="schachttyp" hidden="0"/>
      <column width="-1" type="field" name="simstatus" hidden="0"/>
      <column width="-1" type="field" name="material" hidden="0"/>
      <column width="-1" type="field" name="xsch" hidden="0"/>
      <column width="-1" type="field" name="ysch" hidden="0"/>
      <column width="-1" type="field" name="kommentar" hidden="0"/>
      <column width="-1" type="field" name="createdat" hidden="0"/>
      <column width="-1" type="field" name="geop" hidden="0"/>
