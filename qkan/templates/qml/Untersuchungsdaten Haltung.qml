...
<qgis styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|AttributeTable|Rendering|CustomProperties|Temporal|Notes" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" readOnly="0" minScale="100000000" symbologyReferenceScale="-1" maxScale="0" simplifyDrawingHints="1" simplifyLocal="1" version="3.22.16-Białowieża" simplifyMaxScale="1" simplifyDrawingTol="1" labelsEnabled="1">
  ...
  <renderer-v2 symbollevels="0" referencescale="-1" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{4c108ca8-1203-477a-9f48-96d4e381b74c}">
      <rule symbol="0" filter="min(ZD, ZB, ZS) = 0" key="{7d940636-afec-4238-8412-8e5bd6db260b}" label="Zustandsklasse 0, starker Mangel"/>
      <rule symbol="1" filter="min(ZD, ZB, ZS) = 1" key="{6ac64b31-87c5-46df-b895-c8f9618ff645}" label="Zustandsklasse 1, starker Mangel"/>
      ...
      <rule symbol="6" filter="(min(ZD, ZB, ZS) &lt; 1 OR min(ZD, ZB, ZS) > 5)" key="{06fa0df9-3a60-4a3c-a72c-ca8f10d3ad45}"/>
    </rules>
    <symbols>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="untersuchhal"/>
  ...
  <expressionfields/>
  <attributeactions>
    <defaultAction key="Canvas" value="{81fbb5a5-5cce-4004-9f8f-d46ab31c0e5d}"/>
    ...
    <actionsetting name="Zustandsdatenfür alle Haltungen anzeigen" capture="0" isEnabledOnlyWhenEditable="0" shortTitle="" action="from qkan.tools.zeige_untersuchungsdaten import ShowHaltungsschaeden&#xd;&#xa;&#xd;&#xa;form = ShowHaltungsschaeden('', '', '')&#xd;&#xa;form.show_selected()&#xd;&#xa;del form&#xd;&#xa;" id="{b8a6ef63-40f5-4eb6-8b35-d05b36b01f7d}" icon="" type="1" notificationMessage="">
      <actionScope id="Canvas"/>
      <actionScope id="Feature"/>
    </actionsetting>
    <actionsetting name="Zustandsdaten für ein Haltung anzeigen" capture="0" isEnabledOnlyWhenEditable="0" shortTitle="" action="# Haltungen untersucht: Zustandsdaten für eine Haltung anzeigen&#xd;&#xa;from qkan.tools.zeige_untersuchungsdaten import ShowHaltungsschaeden&#xd;&#xa;&#xd;&#xa;form = ShowHaltungsschaeden('[%untersuchhal%]', '', '', '[%untersuchtag%]')&#xd;&#xa;form.show_selected()&#xd;&#xa;del form&#xd;&#xa;&#xd;&#xa;" id="{81fbb5a5-5cce-4004-9f8f-d46ab31c0e5d}" icon="" type="1" notificationMessage="">
      <actionScope id="Canvas"/>
      <actionScope id="Feature"/>
    </actionsetting>
  </attributeactions>
  <attributetableconfig sortOrder="1" actionWidgetStyle="dropDown" sortExpression="&quot;video_offset&quot;">
    <columns>
      ...
      <column name="pos_bis" hidden="0" width="100" type="field"/>
      <column name="foto_dateiname" hidden="0" width="508" type="field"/>
      <column name="film_dateiname" hidden="0" width="584" type="field"/>
