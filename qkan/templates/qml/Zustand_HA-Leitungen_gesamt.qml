...
<qgis maxScale="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|AttributeTable|Rendering|CustomProperties|Relations|Temporal|Legend|Notes" simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" symbologyReferenceScale="-1" simplifyDrawingTol="1" minScale="100000000" simplifyLocal="1" labelsEnabled="0" version="3.28.15-Firenze" readOnly="0">
  ...
  <attributeactions>
    ...
    <actionsetting id="{7f802d16-fd1e-45ac-9683-a33a61fc674b}" isEnabledOnlyWhenEditable="0" type="1" icon="" capture="1" notificationMessage="" shortTitle="Aktuelle Zustandsdaten" action="from qkan.tools.zeige_untersuchungsdaten import ShowHausanschlussschaeden&#xd;&#xa;&#xd;&#xa;form = ShowHausanschlussschaeden(id = 1)&#xd;&#xa;form.show_selected()&#xd;&#xa;del form&#xd;&#xa;" name="Aktuelle Zustandsdaten für alle Hausanschlussleitungen anzeigen">
      <actionScope id="Feature"/>
      <actionScope id="Layer"/>
      <actionScope id="Canvas"/>
    </actionsetting>
    <actionsetting id="{33764888-a85a-479d-961f-e1e8dc370402}" isEnabledOnlyWhenEditable="0" type="1" icon="" capture="0" notificationMessage="" shortTitle="Aktuelle Zustandsdaten zu Hausanschlussleitung" action="from qkan.tools.zeige_untersuchungsdaten import ShowHaltungsschaeden&#xd;&#xa;form = ShowHausanschlussschaeden(untersuchleit = '[%leitnam%]', id = 1)&#xd;&#xa;form.show_selected()&#xd;&#xa;del form&#xd;&#xa;" name="Aktuelle Zustandsdaten zu Hausanschlussleitung anzeigen">
      <actionScope id="Feature"/>
      <actionScope id="Canvas"/>
    </actionsetting>
    <actionsetting id="{f0ac47bb-207a-48d1-8d1d-b983bc11a172}" isEnabledOnlyWhenEditable="0" type="1" icon="" capture="1" notificationMessage="" shortTitle="Alle Zustandsdaten" action="from qkan.tools.zeige_untersuchungsdaten import ShowHausanschlussschaeden&#xd;&#xa;&#xd;&#xa;form = ShowHausanschlussschaeden()&#xd;&#xa;form.show_selected()&#xd;&#xa;del form&#xd;&#xa;" name="Alle Zustandsdaten für alle Hausanschlussleitungen anzeigen">
      <actionScope id="Feature"/>
      <actionScope id="Layer"/>
      <actionScope id="Canvas"/>
    </actionsetting>
    <actionsetting id="{df45edbe-ca08-43ef-85cf-7e9ae15140b0}" isEnabledOnlyWhenEditable="0" type="1" icon="" capture="1" notificationMessage="" shortTitle="Zustandsdaten zu Hausanschlussleitung und Untersuchungsdatum" action="from qkan.tools.zeige_untersuchungsdaten import ShowHausanschlussschaeden&#xd;&#xa;&#xd;&#xa;form = ShowHausanschlussschaeden(untersuchleit = '[%leitnam%]', untersuchtag = '[%untersuchtag%]')&#xd;&#xa;form.show_selected()&#xd;&#xa;del form&#xd;&#xa;&#xd;&#xa;" name="Zustandsdaten zu Hausanschlussleitung und Untersuchungsdatum anzeigen">
      <actionScope id="Feature"/>
      <actionScope id="Canvas"/>
    </actionsetting>
  </attributeactions>
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="1" sortExpression="&quot;haltnam&quot;">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="untersuchrichtung"/>
