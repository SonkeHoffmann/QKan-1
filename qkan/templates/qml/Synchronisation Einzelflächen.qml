...
<qgis version="3.28.13-Firenze" styleCategories="Symbology|Forms|AttributeTable|Notes">
    ...
    <symbols>
      <symbol type="fill" clip_to_extent="1" is_animated="0" name="0" alpha="1" frame_rate="10" force_rhr="0">
        ...
        <layer pass="0" enabled="1" locked="0" class="LinePatternFill">
          ...
          <symbol type="line" clip_to_extent="1" is_animated="0" name="@0@0" alpha="1" frame_rate="10" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" name="name" value=""/>
                <Option name="properties"/>
          ...
          <effect enabled="1" type="effectStack">
            ...
            <effect type="outerGlow">
              <Option type="Map">
                ...
                <Option type="QString" name="single_color" value="255,0,0,255"/>
            ...
            <effect type="innerShadow">
              <Option type="Map">
                ...
                <Option type="QString" name="offset_unit" value="MM"/>
                <Option type="QString" name="offset_unit_scale" value="3x:0,0,0,0,0,0"/>
                <Option type="QString" name="opacity" value="0.15"/>
              </Option>
            </effect>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="aktion" hidden="0" width="-1"/>
      <column type="field" name="flnam" hidden="0" width="-1"/>
      <column type="field" name="objekt" hidden="0" width="-1"/>
      <column type="field" name="haltnam" hidden="0" width="-1"/>
      <column type="field" name="schnam" hidden="0" width="-1"/>
      <column type="field" name="neigkl" hidden="0" width="-1"/>
      <column type="field" name="neigung" hidden="0" width="-1"/>
      <column type="field" name="teilgebiet" hidden="0" width="-1"/>
      <column type="field" name="regenschreiber" hidden="0" width="-1"/>
      <column type="field" name="abflussparameter" hidden="0" width="-1"/>
      <column type="field" name="aufteilen" hidden="0" width="-1"/>
  ...
  <conditionalstyles>
    <rowstyles>
      <style background_color="#b2df8a" rule="status and aktion = 'hinzuf�gen'" name="hinzuf�gen" background_color_alpha="255">
        <font bold="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style=""/>
      </style>
      <style text_color_alpha="255" text_color="#33a02c" rule="not status and aktion = 'hinzuf�gen'" name="hinzuf�gen nicht ausf�hren">
        <font bold="0" description="MS Shell Dlg 2,8.25,-1,5,50,1,0,1,0,0" italic="1" underline="0" strikethrough="1" style=""/>
      </style>
      <style background_color="#fdbf6f" rule="status and aktion = '�ndern'" name="�ndern" background_color_alpha="255">
        <font bold="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style=""/>
      </style>
      <style text_color_alpha="255" text_color="#ff7f00" rule="not status and aktion = '�ndern'" name="�ndern nicht ausf�hren">
        <font bold="0" description="MS Shell Dlg 2,8.3,-1,5,50,1,0,1,0,0" italic="1" underline="0" strikethrough="1" style=""/>
      </style>
      <style background_color="#fb9a99" rule="status and aktion = 'l�schen'" name="l�schen" background_color_alpha="255">
        <font bold="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" strikethrough="0" style=""/>
      </style>
      <style text_color_alpha="255" text_color="#e31a1c" rule="not status and aktion = 'l�schen'" name="l�schen nicht ausf�hren">
        <font bold="0" description="MS Shell Dlg 2,8.3,-1,5,50,1,0,1,0,0" italic="1" underline="0" strikethrough="1" style=""/>
      </style>
      <style background_color="#e6d9ff" text_color_alpha="255" text_color="#5500ff" rule="aktion = 'Bezeichnung im Bestand nicht eindeutig'" name="redundant" background_color_alpha="255">
        <font bold="1" description="MS Shell Dlg 2,8.3,-1,5,75,1,0,0,0,0" italic="1" underline="0" strikethrough="0" style=""/>
      </style>
      <style background_color="#efd9ff" text_color_alpha="255" text_color="#9500ff" rule="aktion = 'Bezeichnung extern nicht eindeutig'" name="redundant extern" background_color_alpha="255">
        <font bold="1" description="MS Shell Dlg 2,8.3,-1,5,75,1,0,0,0,0" italic="1" underline="0" strikethrough="0" style=""/>
      </style>
    </rowstyles>
    <fieldstyles/>
  ...
  <editable>
    ...
    <field name="flnam" editable="0"/>
    <field name="objekt" editable="0"/>
    <field name="haltnam" editable="0"/>
    <field name="schnam" editable="0"/>
    <field name="neigkl" editable="0"/>
    <field name="neigung" editable="0"/>
    <field name="teilgebiet" editable="0"/>
    <field name="regenschreiber" editable="0"/>
    <field name="abflussparameter" editable="0"/>
    <field name="aufteilen" editable="0"/>
