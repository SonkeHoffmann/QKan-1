...
<qgis hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyLocal="1" simplifyDrawingTol="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" readOnly="0" labelsEnabled="0" simplifyDrawingHints="1" maxScale="0" version="3.34.7-Prizren" simplifyAlgorithm="0" simplifyMaxScale="1">
  <flags>
  ...
  <elevation zoffset="0" extrusion="0" showMarkerSymbolInSurfacePlots="0" extrusionEnabled="0" respectLayerSymbol="1" binding="Centroid" type="IndividualFeatures" symbology="Line" clamping="Terrain" zscale="1">
    ...
    <profileLineSymbol>
      <symbol alpha="1" type="line" clip_to_extent="1" frame_rate="10" name="" is_animated="0" force_rhr="0">
        ...
        <layer id="{0a270054-8f6e-4768-8705-683442915182}" class="SimpleLine" pass="0" enabled="1" locked="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol alpha="1" type="fill" clip_to_extent="1" frame_rate="10" name="" is_animated="0" force_rhr="0">
        ...
        <layer id="{c59bf1b5-d4b6-4a97-afef-dbaeb7fc23b4}" class="SimpleFill" pass="0" enabled="1" locked="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol alpha="1" type="marker" clip_to_extent="1" frame_rate="10" name="" is_animated="0" force_rhr="0">
        ...
        <layer id="{74f4d6f7-7ee6-4b20-b95f-4488ed0a7ff1}" class="SimpleMarker" pass="0" enabled="1" locked="0">
          <Option type="Map">
  ...
  <renderer-v2 referencescale="-1" type="singleSymbol" symbollevels="0" forceraster="0" enableorderby="0">
    <symbols>
      <symbol alpha="1" type="line" clip_to_extent="1" frame_rate="10" name="0" is_animated="0" force_rhr="0">
        ...
        <layer id="{68283810-6fa5-4d30-ab00-db1aa2b20d1e}" class="MarkerLine" pass="0" enabled="1" locked="0">
          <Option type="Map">
          ...
          <symbol alpha="1" type="marker" clip_to_extent="1" frame_rate="10" name="@0@0" is_animated="0" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer id="{d09d71d4-2270-422d-ade6-f3fe4e039ac8}" class="SimpleMarker" pass="0" enabled="1" locked="0">
              <Option type="Map">
                <Option value="0" type="QString" name="angle"/>
                <Option value="square" type="QString" name="cap_style"/>
                ...
                <Option value="bevel" type="QString" name="joinstyle"/>
                <Option value="diagonal_half_square" type="QString" name="name"/>
                <Option value="0,0" type="QString" name="offset"/>
                <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
        ...
        <layer id="{4fa51443-2c3a-44a4-8f9e-5a8a796fb623}" class="SimpleLine" pass="0" enabled="1" locked="0">
          <Option type="Map">
            <Option value="0" type="QString" name="align_dash_pattern"/>
            <Option value="square" type="QString" name="capstyle"/>
            <Option value="5;2" type="QString" name="customdash"/>
            ...
            <Option value="MM" type="QString" name="line_width_unit"/>
            <Option value="5.55112e-17" type="QString" name="offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
            <Option value="0" type="QString" name="ring_filter"/>
            <Option value="0" type="QString" name="trim_distance_end"/>
        ...
        <layer id="{4dc27d62-55be-4ad0-ae22-36bc45dbbb46}" class="SimpleLine" pass="1" enabled="1" locked="0">
          <Option type="Map">
            <Option value="0" type="QString" name="align_dash_pattern"/>
            <Option value="square" type="QString" name="capstyle"/>
            <Option value="5;2" type="QString" name="customdash"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" type="line" clip_to_extent="1" frame_rate="10" name="" is_animated="0" force_rhr="0">
        ...
        <layer id="{d2698fa9-c36e-45cf-b518-1dfceb5267c4}" class="SimpleLine" pass="0" enabled="1" locked="0">
          <Option type="Map">
            <Option value="0" type="QString" name="align_dash_pattern"/>
            <Option value="square" type="QString" name="capstyle"/>
            <Option value="5;2" type="QString" name="customdash"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory minScaleDenominator="0" width="15" lineSizeType="MM" showAxis="1" backgroundColor="#ffffff" spacing="5" penAlpha="255" lineSizeScale="3x:0,0,0,0,0,0" scaleDependency="Area" enabled="0" diagramOrientation="Up" sizeType="MM" labelPlacementMethod="XHeight" scaleBasedVisibility="0" barWidth="5" penColor="#000000" minimumSize="0" backgroundAlpha="255" opacity="1" penWidth="0" sizeScale="3x:0,0,0,0,0,0" direction="0" maxScaleDenominator="1e+08" spacingUnitScale="3x:0,0,0,0,0,0" height="15" spacingUnit="MM" rotationOffset="270">
      <fontProperties bold="0" style="" underline="0" italic="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" strikethrough="0"/>
      ...
      <axisSymbol>
        <symbol alpha="1" type="line" clip_to_extent="1" frame_rate="10" name="" is_animated="0" force_rhr="0">
          ...
          <layer id="{a9cda7e7-2631-46d4-bd3e-a25dab43acc7}" class="SimpleLine" pass="0" enabled="1" locked="0">
            <Option type="Map">
              <Option value="0" type="QString" name="align_dash_pattern"/>
              <Option value="square" type="QString" name="capstyle"/>
              <Option value="5;2" type="QString" name="customdash"/>
  ...
  <DiagramLayerSettings priority="0" zIndex="0" obstacle="0" dist="0" placement="2" linePlacementFlags="18" showAll="1">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
  ...
  <storedexpressions/>
  <editform tolerant="1">C:/Users/Users/hoettges/AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins/qkan/forms/qkan_anschlussleitungen.ui</editform>
  <editforminit/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="1" name="anschlusstyp"/>
