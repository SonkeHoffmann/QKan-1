...
<qgis styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|AttributeTable|Rendering|CustomProperties|Temporal|Notes" hasScaleBasedVisibilityFlag="1" simplifyAlgorithm="0" readOnly="0" minScale="0" symbologyReferenceScale="-1" maxScale="1" simplifyDrawingHints="0" simplifyLocal="1" version="3.22.16-Białowieża" simplifyMaxScale="1" simplifyDrawingTol="1" labelsEnabled="1">
  <flags>
  ...
  <temporal limitMode="0" enabled="0" fixedDuration="0" startExpression="" endExpression="" mode="0" durationField="pk" startField="" accumulate="0" endField="" durationUnit="min">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <renderer-v2 symbollevels="0" referencescale="-1" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{228d5431-8f44-40a0-9f32-4ab249f2b5b8}">
      <rule scalemaxdenom="500" key="{7a315328-c986-4768-8f34-85184ac94014}" label=">1:500">
        <rule symbol="0" filter="&quot;entwart&quot; = 'Mischwasser'" key="{90add3db-d470-469a-aa61-fb145e19656f}" label="Mischwasser"/>
        <rule symbol="1" filter="&quot;entwart&quot; = 'Regenwasser'" key="{70bf1df3-eafd-463d-b68e-c0f640e20674}" label="Regenwasser"/>
        <rule symbol="2" filter="&quot;entwart&quot; = 'Schmutzwasser'" key="{e7360ab6-96c3-4d12-bb06-015e14a1d486}" label="Schmutzwasser"/>
        <rule symbol="3" filter="&quot;entwart&quot; = 'Rinnen/Gräben'" key="{07e8a2eb-9665-435c-8e87-2c69926e09ac}" label="Rinnen/Gräben"/>
        <rule symbol="4" filter="simstatus IN ('außer Betrieb', 'stillgelegt', 'verdämmert', 'fiktiv', 'rückgebaut')" key="{27ab1c10-b535-4e51-ae40-b7c256e6bd00}" label="stillgelegt"/>
        <rule description="sonstige" symbol="5" filter="ELSE" key="{783b79a0-fe47-4163-a434-b1e06b96cacd}" label="sonstige"/>
      </rule>
      <rule scalemaxdenom="10000" scalemindenom="500" key="{e05438f5-a656-42d1-ac7f-8028b529f31d}" label=">1:10000">
        <rule symbol="6" filter="&quot;entwart&quot; = 'Mischwasser'" key="{1660e41a-bcee-4000-851b-4ffbd84f067b}" label="Mischwasser"/>
        <rule symbol="7" filter="&quot;entwart&quot; = 'Regenwasser'" key="{6b527d4e-ae32-40c2-8dfc-07c45c96098b}" label="Regenwasser"/>
        <rule symbol="8" filter="&quot;entwart&quot; = 'Schmutzwasser'" key="{e5931154-729e-447c-9f78-f9ab4891db9b}" label="Schmutzwasser"/>
        <rule symbol="9" filter="&quot;entwart&quot; = 'Rinnen/Gräben'" key="{0c427e9f-b674-46d8-b28a-0b704f7beffb}" label="Rinnen/Gräben"/>
        <rule symbol="10" filter="simstatus IN ('außer Betrieb', 'stillgelegt', 'verdämmert', 'fiktiv', 'rückgebaut')" key="{fc37676f-3d16-410e-84a2-40bf9ccf47d0}" label="stillgelegt"/>
        <rule description="sonstige" symbol="11" filter="ELSE" key="{dc84e2e3-93cd-49f9-ac6a-c1b72754a900}" label="sonstige"/>
      </rule>
      <rule description="weit entfernt" symbol="12" filter="True" scalemindenom="10000" key="{2d10dc81-3792-478e-9fdb-6ab4a4cb14f1}" label="diverse"/>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineWidth" type="Map">
                  ...
                  <Option name="expression" value="1.1 * if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineWidth" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
              <Option name="type" value="collection" type="QString"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineWidth" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="1 + 4 * if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
              <Option name="type" value="collection" type="QString"/>
                ...
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="size" type="Map">
                      <Option name="active" value="true" type="bool"/>
                      <Option name="expression" value="2 * if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString"/>
                      <Option name="type" value="3" type="int"/>
                    </Option>
                  </Option>
                  <Option name="type" value="collection" type="QString"/>
      ...
      <symbol force_rhr="0" name="1" type="line" alpha="1" clip_to_extent="1">
        ...
        <layer enabled="1" pass="2" locked="0" class="MarkerLine">
          ...
          <symbol force_rhr="0" name="@1@2" type="marker" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" name="10" type="line" alpha="1" clip_to_extent="1">
        ...
        <layer enabled="1" pass="2" locked="0" class="MarkerLine">
          ...
          <symbol force_rhr="0" name="@10@0" type="marker" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
              ...
              <data_defined_properties>
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="size" type="Map">
                      <Option name="active" value="true" type="bool"/>
                      <Option name="expression" value="0.6 + 3 * if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString"/>
                      <Option name="type" value="3" type="int"/>
                    </Option>
                  </Option>
                  <Option name="type" value="collection" type="QString"/>
      ...
      <symbol force_rhr="0" name="11" type="line" alpha="1" clip_to_extent="1">
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineWidth" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="0.44 + 2.2 * if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
              <Option name="type" value="collection" type="QString"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineWidth" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="0.4 + 2 * if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
              <Option name="type" value="collection" type="QString"/>
        ...
        <layer enabled="1" pass="2" locked="0" class="MarkerLine">
          ...
          <symbol force_rhr="0" name="@11@2" type="marker" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" name="2" type="line" alpha="1" clip_to_extent="1">
        ...
        <layer enabled="1" pass="2" locked="0" class="MarkerLine">
          ...
          <symbol force_rhr="0" name="@2@2" type="marker" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="interval" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="4 * if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
                <Option name="outlineWidth" type="Map">
                  <Option name="active" value="false" type="bool"/>
      ...
      <symbol force_rhr="0" name="5" type="line" alpha="1" clip_to_extent="1">
        ...
        <layer enabled="1" pass="2" locked="0" class="MarkerLine">
          ...
          <symbol force_rhr="0" name="@5@2" type="marker" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol force_rhr="0" name="6" type="line" alpha="1" clip_to_extent="1">
        ...
        <layer enabled="1" pass="1" locked="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option name="customdash" value="5;2;2;2" type="QString"/>
            <Option name="customdash_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="customdash_unit" value="MM" type="QString"/>
            <Option name="dash_pattern_offset" value="0" type="QString"/>
            <Option name="dash_pattern_offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            ...
            <Option name="line_color" value="174,0,254,255" type="QString"/>
            <Option name="line_style" value="solid" type="QString"/>
            <Option name="line_width" value="1" type="QString"/>
            <Option name="line_width_unit" value="MM" type="QString"/>
            <Option name="offset" value="0" type="QString"/>
      ...
      <symbol force_rhr="0" name="7" type="line" alpha="1" clip_to_extent="1">
        ...
        <layer enabled="1" pass="2" locked="0" class="MarkerLine">
          ...
          <symbol force_rhr="0" name="@7@1" type="marker" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{ac2b49a3-c5da-4180-aef6-cf024cfdaab4}">
      <rule description="Beschriftung Kreisquerschnitt 1:1000" scalemaxdenom="1000" key="{cf532acb-1c44-4652-b0a4-2a42a660d41f}">
        <settings calloutType="simple">
          <text-style fontSizeUnit="Point" fontItalic="0" fontFamily="MS Shell Dlg 2" legendString="Aa" fontKerning="1" textOrientation="horizontal" isExpression="1" textColor="0,0,0,255" fontSize="9" fontLetterSpacing="0" capitalization="0" fieldName="&quot;haltnam&quot; || '  -  ' || &quot;profilnam&quot;  || '  -  ' ||'DN ' || format_number(hoehe,0) || '  -  ' || format_number(((( sohleoben - sohleunten ) /  laenge )*1000),1) || ' ‰'" useSubstitutions="0" fontWeight="50" fontUnderline="0" allowHtml="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" multilineHeight="1" textOpacity="1" fontStrikeout="0" fontWordSpacing="0" namedStyle="Standard">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferNoFill="0" bufferSizeUnits="MM" bufferJoinStyle="64" bufferOpacity="1" bufferBlendMode="0" bufferDraw="1" bufferSize="1"/>
            <text-mask maskEnabled="0" maskSize="0" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSizeUnits="MM" maskJoinStyle="128" maskOpacity="1" maskedSymbolLayers=""/>
            <background shapeBorderWidth="0" shapeRadiiUnit="MM" shapeSVGFile="" shapeSizeUnit="MM" shapeBorderColor="128,128,128,255" shapeSizeType="0" shapeRotationType="0" shapeOffsetX="0" shapeBlendMode="0" shapeFillColor="255,255,255,255" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeDraw="0" shapeRadiiX="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeRadiiY="0" shapeOffsetUnit="MM" shapeRotation="0" shapeType="0" shapeOpacity="1" shapeSizeX="0" shapeSizeY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0">
          ...
          <text-format leftDirectionSymbol="&lt;" placeDirectionSymbol="0" formatNumbers="0" multilineAlign="0" addDirectionSymbol="0" rightDirectionSymbol=">" autoWrapLength="0" decimals="3" reverseDirectionSymbol="0" plussign="0" wrapChar="" useMaxLineLengthForAutoWrap="1"/>
          <placement centroidInside="0" offsetType="0" repeatDistance="0" placement="2" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" polygonPlacementFlags="2" geometryGenerator="" offsetUnits="MapUnit" priority="5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" xOffset="0" overrunDistanceUnit="MM" lineAnchorType="0" yOffset="0" maxCurvedCharAngleIn="20" placementFlags="10" dist="2" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="LineGeometry" repeatDistanceUnits="MM" rotationUnit="AngleDegrees" fitInPolygonOnly="0" geometryGeneratorEnabled="0" rotationAngle="0" quadOffset="4" distUnits="MM" maxCurvedCharAngleOut="-20" lineAnchorClipping="0" geometryGeneratorType="PointGeometry" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" lineAnchorPercent="0.5" overrunDistance="0"/>
          <rendering scaleMax="5000" zIndex="0" unplacedVisibility="0" fontLimitPixelSize="0" fontMaxPixelSize="10000" fontMinPixelSize="3" limitNumLabels="0" minFeatureSize="0" displayAll="0" obstacleType="0" scaleVisibility="1" labelPerPart="0" mergeLines="0" scaleMin="1" maxNumLabels="2000" obstacle="1" upsidedownLabels="0" obstacleFactor="1" drawLabels="1"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
              <Option name="properties"/>
      ...
      <rule description="Beschriftung Kreisquerschnitt 1:2500" scalemaxdenom="2500" scalemindenom="1000" key="{7c99de43-a7d2-4413-a5b4-212b04823efd}">
        <settings calloutType="simple">
          <text-style fontSizeUnit="Point" fontItalic="0" fontFamily="MS Shell Dlg 2" legendString="Aa" fontKerning="1" textOrientation="horizontal" isExpression="0" textColor="50,50,50,255" fontSize="10" fontLetterSpacing="0" capitalization="0" fieldName="haltnam" useSubstitutions="0" fontWeight="50" fontUnderline="0" allowHtml="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" multilineHeight="1" textOpacity="1" fontStrikeout="0" fontWordSpacing="0" namedStyle="Regular">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="250,250,250,255" bufferNoFill="1" bufferSizeUnits="MM" bufferJoinStyle="128" bufferOpacity="1" bufferBlendMode="0" bufferDraw="1" bufferSize="0.80000000000000004"/>
            <text-mask maskEnabled="0" maskSize="0" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSizeUnits="MM" maskJoinStyle="128" maskOpacity="1" maskedSymbolLayers=""/>
            <background shapeBorderWidth="0" shapeRadiiUnit="Point" shapeSVGFile="" shapeSizeUnit="Point" shapeBorderColor="128,128,128,255" shapeSizeType="0" shapeRotationType="0" shapeOffsetX="0" shapeBlendMode="0" shapeFillColor="255,255,255,255" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="Point" shapeDraw="0" shapeRadiiX="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeRadiiY="0" shapeOffsetUnit="Point" shapeRotation="0" shapeType="0" shapeOpacity="1" shapeSizeX="0" shapeSizeY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0">
              <symbol force_rhr="0" name="markerSymbol" type="marker" alpha="1" clip_to_extent="1">
                <data_defined_properties>
                  <Option type="Map">
                    <Option name="name" value="" type="QString"/>
            ...
            <shadow shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowDraw="0" shadowOffsetGlobal="1" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowOpacity="0.69999999999999996" shadowRadius="1.5" shadowUnder="0" shadowRadiusAlphaOnly="0" shadowScale="100" shadowOffsetUnit="MM" shadowBlendMode="6" shadowOffsetAngle="135" shadowRadiusUnit="MM" shadowColor="0,0,0,255" shadowOffsetDist="1"/>
            <dd_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
          ...
          <text-format leftDirectionSymbol="&lt;" placeDirectionSymbol="0" formatNumbers="0" multilineAlign="0" addDirectionSymbol="0" rightDirectionSymbol=">" autoWrapLength="0" decimals="3" reverseDirectionSymbol="0" plussign="0" wrapChar="" useMaxLineLengthForAutoWrap="1"/>
          <placement centroidInside="0" offsetType="0" repeatDistance="0" placement="2" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" polygonPlacementFlags="2" geometryGenerator="" offsetUnits="MM" priority="5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" xOffset="0" overrunDistanceUnit="MM" lineAnchorType="0" yOffset="0" maxCurvedCharAngleIn="25" placementFlags="10" dist="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="LineGeometry" repeatDistanceUnits="MM" rotationUnit="AngleDegrees" fitInPolygonOnly="0" geometryGeneratorEnabled="0" rotationAngle="0" quadOffset="4" distUnits="MM" maxCurvedCharAngleOut="-25" lineAnchorClipping="0" geometryGeneratorType="PointGeometry" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" lineAnchorPercent="0.5" overrunDistance="0"/>
          <rendering scaleMax="0" zIndex="0" unplacedVisibility="0" fontLimitPixelSize="0" fontMaxPixelSize="10000" fontMinPixelSize="3" limitNumLabels="0" minFeatureSize="0" displayAll="0" obstacleType="1" scaleVisibility="0" labelPerPart="0" mergeLines="0" scaleMin="0" maxNumLabels="2000" obstacle="1" upsidedownLabels="0" obstacleFactor="1" drawLabels="1"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
              <Option name="properties"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="Description" value="" type="QString"/>
            <Option name="FilterExpression" value="" type="QString"/>
            <Option name="Key" value="name" type="QString"/>
            <Option name="Layer" value="eigentum_a1c903df_4af8_4ecf_9da6_8892afa11450" type="QString"/>
            <Option name="LayerName" value="Eigentum" type="QString"/>
            <Option name="LayerProviderName" value="spatialite" type="QString"/>
            <Option name="LayerSource" value="dbname='itwh.sqlite' table=&quot;eigentum&quot;" type="QString"/>
            <Option name="NofColumns" value="1" type="int"/>
            <Option name="OrderByValue" value="false" type="bool"/>
            <Option name="UseCompleter" value="true" type="bool"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="LayerProviderName" value="spatialite" type="QString"/>
            <Option name="LayerSource" value="dbname='itwh.sqlite' table=&quot;profile&quot;" type="QString"/>
            <Option name="NofColumns" value="1" type="int"/>
            <Option name="OrderByValue" value="false" type="bool"/>
            <Option name="UseCompleter" value="true" type="bool"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="LayerProviderName" value="spatialite" type="QString"/>
            <Option name="LayerSource" value="dbname='itwh.sqlite' table=&quot;entwaesserungsarten&quot;" type="QString"/>
            <Option name="NofColumns" value="1" type="int"/>
            <Option name="OrderByValue" value="false" type="bool"/>
            <Option name="UseCompleter" value="true" type="bool"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="LayerProviderName" value="spatialite" type="QString"/>
            <Option name="LayerSource" value="dbname='itwh.sqlite' table=&quot;simulationsstatus&quot;" type="QString"/>
            <Option name="NofColumns" value="1" type="int"/>
            <Option name="OrderByValue" value="false" type="bool"/>
            <Option name="UseCompleter" value="true" type="bool"/>
            <Option name="Value" value="bezeichnung" type="QString"/>
  ...
  <aliases>
    ...
    <alias name="Bezeichnung" index="1" field="haltnam"/>
    ...
    <alias name="Eigentümer" index="11" field="eigentum"/>
    <alias name="Teilgebiet" index="12" field="teilgebiet"/>
    <alias name="Straße" index="13" field="strasse"/>
    <alias name="Profilbezeichnung" index="14" field="profilnam"/>
    <alias name="Entwässerungssystem" index="15" field="entwart"/>
    <alias name="Material" index="16" field="material"/>
    <alias name="Profilauskleidung" index="17" field="profilauskleidung"/>
    <alias name="Innenmaterial" index="18" field="innenmaterial"/>
    <alias name="Rauheitsbeiwert" index="19" field="ks"/>
    <alias name="Elementtyp" index="20" field="haltungstyp"/>
    <alias name="Planungsstatus" index="21" field="simstatus"/>
    <alias name="Transporthaltung" index="22" field="transport"/>
    ...
    <alias name="y Ende" index="27" field="yschun"/>
    <alias name="Kommentar" index="28" field="kommentar"/>
    <alias name="erstellt" index="29" field="createdat"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="schoben"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="schunten"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="hoehe"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="breite"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="laenge"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="aussendurchmesser"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="sohleoben"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="sohleunten"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="baujahr"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="eigentum"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="teilgebiet"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="strasse"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="profilnam"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="entwart"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="material"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="profilauskleidung"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="innenmaterial"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="ks"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="haltungstyp"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="simstatus"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="transport"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="druckdicht"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="xschob"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="yschob"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="xschun"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="yschun"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="innenmaterial" hidden="0" width="100" type="field"/>
      ...
      <column name="entwart" hidden="0" width="170" type="field"/>
      ...
      <column name="transport" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <reuseLastValue>
    ...
    <field name="transport" reuseLastValue="0"/>
