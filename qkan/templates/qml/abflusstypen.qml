...
<qgis hasScaleBasedVisibilityFlag="0" readOnly="0" minScale="0" version="3.34.7-Prizren" styleCategories="AllStyleCategories" maxScale="0">
  ...
  <elevation extrusionEnabled="0" symbology="Line" showMarkerSymbolInSurfacePlots="0" clamping="Terrain" zoffset="0" respectLayerSymbol="1" type="IndividualFeatures" extrusion="0" zscale="1" binding="Centroid">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="line" force_rhr="0" clip_to_extent="1" name="">
        ...
        <layer enabled="1" class="SimpleLine" pass="0" locked="0" id="{adac7edb-7f11-415f-9cae-4b0931407b86}">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="fill" force_rhr="0" clip_to_extent="1" name="">
        ...
        <layer enabled="1" class="SimpleFill" pass="0" locked="0" id="{8cebb741-8a58-4916-84f8-ae919ffb689a}">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="marker" force_rhr="0" clip_to_extent="1" name="">
        ...
        <layer enabled="1" class="SimpleMarker" pass="0" locked="0" id="{e47492cf-20e3-4531-92b0-fac2bf59289a}">
          <Option type="Map">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="abflusstyp">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
  ...
  <splitPolicies>
    ...
    <policy policy="DefaultValue" field="abflusstyp"/>
  ...
  <storedexpressions/>
  <editform tolerant="1">C:\Users/nb9255e/AppData/Roaming/QGIS/QGIS3\profiles\default/python/plugins\qkan\forms\forms</editform>
  <editforminit/>
