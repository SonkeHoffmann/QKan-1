...
<qgis hasScaleBasedVisibilityFlag="0" readOnly="0" maxScale="0" minScale="100000000" simplifyDrawingHints="0" symbologyReferenceScale="-1" simplifyDrawingTol="1" simplifyLocal="1" labelsEnabled="1" simplifyAlgorithm="0" version="3.28.13-Firenze" simplifyMaxScale="1" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|AttributeTable|Rendering|CustomProperties|GeometryOptions|Temporal|Legend|Notes">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontKerning="1" fontUnderline="1" textOrientation="horizontal" multilineHeightUnit="Percentage" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" fontWeight="75" textOpacity="1" capitalization="0" blendMode="0" fontSize="10" fontFamily="MS Shell Dlg 2" fontLetterSpacing="0" allowHtml="0" fontStrikeout="0" textColor="113,114,113,255" fontItalic="0" fontWordSpacing="0" useSubstitutions="0" forcedBold="0" previewBkgrdColor="255,255,255,255" legendString="Aa" multilineHeight="1" fontSizeUnit="Point" forcedItalic="0" namedStyle="Bold" fieldName="schnam">
        <families/>
        <text-buffer bufferOpacity="1" bufferNoFill="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferBlendMode="0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferDraw="1" bufferSizeUnits="MM"/>
      ...
      <text-format decimals="3" plussign="0" rightDirectionSymbol=">" autoWrapLength="0" reverseDirectionSymbol="0" formatNumbers="0" addDirectionSymbol="0" placeDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" leftDirectionSymbol="&lt;" wrapChar="" multilineAlign="3"/>
      <placement overlapHandling="PreventOverlap" rotationUnit="AngleDegrees" dist="3" yOffset="0" lineAnchorPercent="0" preserveRotation="1" xOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placement="6" layerType="PointGeometry" maxCurvedCharAngleOut="-25" rotationAngle="0" lineAnchorTextPoint="CenterOfText" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" lineAnchorType="0" overrunDistanceUnit="MM" fitInPolygonOnly="0" priority="6" polygonPlacementFlags="2" centroidInside="0" allowDegraded="0" geometryGenerator="" geometryGeneratorEnabled="0" distMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" distUnits="MM" overrunDistance="0" repeatDistanceUnits="MM" geometryGeneratorType="PointGeometry" offsetUnits="MapUnit" lineAnchorClipping="0" centroidWhole="0" repeatDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" offsetType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25"/>
      <rendering scaleMax="10000000" upsidedownLabels="0" fontLimitPixelSize="0" obstacleType="0" zIndex="0" obstacleFactor="1" labelPerPart="0" scaleVisibility="0" scaleMin="1" maxNumLabels="2000" fontMaxPixelSize="10000" obstacle="1" minFeatureSize="0" unplacedVisibility="0" drawLabels="1" mergeLines="0" limitNumLabels="0" fontMinPixelSize="3"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="&quot;pk&quot;">
    <columns>
      ...
      <column width="-1" type="field" name="geom" hidden="0"/>
