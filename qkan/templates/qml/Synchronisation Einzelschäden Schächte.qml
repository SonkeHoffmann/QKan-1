...
<qgis simplifyAlgorithm="0" autoRefreshMode="Disabled" readOnly="0" simplifyDrawingTol="1" simplifyMaxScale="1" symbologyReferenceScale="-1" maxScale="0" version="3.40.14-Bratislava" minScale="100000000" simplifyDrawingHints="1" simplifyLocal="1" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" autoRefreshTime="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|MapTips|AttributeTable|Rendering|CustomProperties|Legend|Notes">
          ...
          <effect type="effectStack" enabled="1">
            ...
            <effect type="outerGlow">
              <Option type="Map">
                ...
                <Option value="239,41,41,255,rgb:0.93725490196078431,0.16078431372549021,0.16078431372549021,1" type="QString" name="single_color"/>
  ...
  <aliases>
    ...
    <alias field="untersuchsch" index="6" name=""/>
    <alias field="id" index="7" name=""/>
    <alias field="untersuchtag" index="8" name=""/>
    <alias field="bandnr" index="9" name=""/>
    <alias field="videozaehler" index="10" name=""/>
    <alias field="timecode" index="11" name=""/>
    <alias field="langtext" index="12" name=""/>
    <alias field="kuerzel" index="13" name=""/>
    <alias field="charakt1" index="14" name=""/>
    <alias field="charakt2" index="15" name=""/>
    <alias field="quantnr1" index="16" name=""/>
    <alias field="quantnr2" index="17" name=""/>
    <alias field="streckenschaden" index="18" name=""/>
    <alias field="streckenschaden_lfdnr" index="19" name=""/>
    <alias field="pos_von" index="20" name=""/>
    <alias field="pos_bis" index="21" name=""/>
    <alias field="vertikale_lage" index="22" name=""/>
    <alias field="inspektionslaenge" index="23" name=""/>
    <alias field="bereich" index="24" name=""/>
    <alias field="foto_dateiname" index="25" name=""/>
    <alias field="ordner_bild" index="26" name=""/>
    <alias field="film_dateiname" index="27" name=""/>
    <alias field="ordner_video" index="28" name=""/>
    <alias field="filmtyp" index="29" name=""/>
    <alias field="video_start" index="30" name=""/>
    <alias field="video_ende" index="31" name=""/>
  ...
  <constraints>
    ...
    <constraint field="untersuchsch" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint field="vertikale_lage" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="inspektionslaenge" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="bereich" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="untersuchsch"/>
      ...
      <column width="-1" hidden="0" type="field" name="vertikale_lage"/>
      <column width="-1" hidden="0" type="field" name="inspektionslaenge"/>
      <column width="-1" hidden="0" type="field" name="bereich"/>
  ...
  <storedexpressions/>
  <editform tolerant="1">C:\Users/hoettges/AppData/Roaming/QGIS/QGIS3\profiles\default/python/plugins\qkan\forms\sync_untersuchdat_schacht.ui</editform>
  <editforminit/>
