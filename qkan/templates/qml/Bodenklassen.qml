...
<qgis hasScaleBasedVisibilityFlag="0" readOnly="0" minScale="0" version="3.34.7-Prizren" styleCategories="AllStyleCategories" maxScale="0">
  ...
  <temporal startField="" startExpression="" durationField="" enabled="0" endExpression="" fixedDuration="0" mode="0" durationUnit="min" limitMode="0" accumulate="0" endField="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <elevation extrusionEnabled="0" symbology="Line" showMarkerSymbolInSurfacePlots="0" clamping="Terrain" zoffset="0" respectLayerSymbol="1" type="IndividualFeatures" extrusion="0" zscale="1" binding="Centroid">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="line" force_rhr="0" clip_to_extent="1" name="">
        ...
        <layer enabled="1" class="SimpleLine" pass="0" locked="0" id="{a4e64559-a0de-4517-8b2a-e02a9030a854}">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="fill" force_rhr="0" clip_to_extent="1" name="">
        ...
        <layer enabled="1" class="SimpleFill" pass="0" locked="0" id="{a0985283-4252-49c2-8f20-a32b84e99f41}">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol is_animated="0" frame_rate="10" alpha="1" type="marker" force_rhr="0" clip_to_extent="1" name="">
        ...
        <layer enabled="1" class="SimpleMarker" pass="0" locked="0" id="{98a60fc8-66b1-4c8c-80de-8ef6f4df7839}">
          <Option type="Map">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="bknam">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" value="0" name="IsMultiline"/>
    ...
    <field configurationFlags="NoFlag" name="infiltrationsrateanfang">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
    ...
    <field configurationFlags="NoFlag" name="infiltrationsrateende">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" value="false" name="IsMultiline"/>
    ...
    <field configurationFlags="NoFlag" name="infiltrationsratestart">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" value="false" name="IsMultiline"/>
    ...
    <field configurationFlags="NoFlag" name="rueckgangskonstante">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" value="0" name="IsMultiline"/>
    ...
    <field configurationFlags="NoFlag" name="regenerationskonstante">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" value="0" name="IsMultiline"/>
    ...
    <field configurationFlags="NoFlag" name="saettigungswassergehalt">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" value="0" name="IsMultiline"/>
    ...
    <field configurationFlags="NoFlag" name="createdat">
      <editWidget type="DateTime">
        <config>
          <Option type="Map">
            <Option type="QString" value="1" name="allow_null"/>
            <Option type="QString" value="1" name="calendar_popup"/>
  ...
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="bknam"/>
    <policy policy="DefaultValue" field="infiltrationsrateanfang"/>
    <policy policy="DefaultValue" field="infiltrationsrateende"/>
    <policy policy="DefaultValue" field="infiltrationsratestart"/>
    <policy policy="Duplicate" field="rueckgangskonstante"/>
    <policy policy="Duplicate" field="regenerationskonstante"/>
    <policy policy="Duplicate" field="saettigungswassergehalt"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column type="field" width="-1" name="bknam" hidden="0"/>
      <column type="field" width="-1" name="infiltrationsrateanfang" hidden="0"/>
      <column type="field" width="-1" name="infiltrationsrateende" hidden="0"/>
      <column type="field" width="-1" name="infiltrationsratestart" hidden="0"/>
      <column type="field" width="-1" name="rueckgangskonstante" hidden="0"/>
      <column type="field" width="-1" name="regenerationskonstante" hidden="0"/>
      <column type="field" width="-1" name="saettigungswassergehalt" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
      <labelFont underline="0" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" bold="0" italic="0"/>
    </labelStyle>
    <attributeEditorField horizontalStretch="0" index="1" name="bknam" showLabel="1" verticalStretch="0">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont underline="0" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" bold="0" italic="0"/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField horizontalStretch="0" index="2" name="infiltrationsrateanfang" showLabel="1" verticalStretch="0">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont underline="0" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" bold="0" italic="0"/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField horizontalStretch="0" index="3" name="infiltrationsrateende" showLabel="1" verticalStretch="0">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont underline="0" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" bold="0" italic="0"/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField horizontalStretch="0" index="4" name="infiltrationsratestart" showLabel="1" verticalStretch="0">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont underline="0" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" bold="0" italic="0"/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField horizontalStretch="0" index="5" name="rueckgangskonstante" showLabel="1" verticalStretch="0">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont underline="0" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" bold="0" italic="0"/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField horizontalStretch="0" index="6" name="regenerationskonstante" showLabel="1" verticalStretch="0">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont underline="0" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" bold="0" italic="0"/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField horizontalStretch="0" index="7" name="saettigungswassergehalt" showLabel="1" verticalStretch="0">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont underline="0" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" bold="0" italic="0"/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField horizontalStretch="0" index="8" name="kommentar" showLabel="1" verticalStretch="0">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont underline="0" strikethrough="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style="" bold="0" italic="0"/>
      </labelStyle>
    </attributeEditorField>
