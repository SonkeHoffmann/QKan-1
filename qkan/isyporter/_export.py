...
class ExportTask:
    ...
    def _export_wehre(self) -> None:
        ...
        if self.vorlage == "":
            ...
            if not self.db_qkan.sqltxt(
                'isy_export_select_wehre',
                "db_qkan: export_wehre",
                replacefun=lambda x: x.format(abfrage_h_where=self.abfrage_h_where)
            ):
                return
    ...
    def _export_pumpen(self) -> None:
        ...
        if self.vorlage == "":
            ...
            if not self.db_qkan.sqltxt(
                'isy_export_select_pumpen',
                "db_qkan: export_pumpen",
                replacefun=lambda x: x.format(abfrage_h_where=self.abfrage_h_where)
            ):
                return
    ...
    def _export_auslaesse(self) -> None:
        ...
        if self.vorlage == "":
            ...
            if not self.db_qkan.sqltxt(
                'isy_export_select_auslaesse',
                "db_qkan: export_auslaesse",
                replacefun=lambda x: x.format(abfrage_s_and=self.abfrage_s_and)
            ):
                return
        ...
        if self.vorlage != "":
            ...
            if not self.db_qkan.sqltxt(
                'isy_export_select_auslaesse_vorlage',
                "db_qkan: export_auslaesse",
                replacefun=lambda x: x.format(abfrage_s_and=self.abfrage_s_and)
            ):
                return
    ...
    def _export_schaechte(self) -> None:
        ...
        if self.vorlage == "":
            ...
            if not self.db_qkan.sqltxt(
                'isy_export_select_schaechte',
                "db_qkan: export_schaechte",
                replacefun=lambda x: x.format(abfrage_s_and=self.abfrage_s_and)
            ):
                return
        ...
        if self.vorlage != "":
            ...
            if not self.db_qkan.sqltxt(
                'isy_export_select_schaechte_vorlage',
                "db_qkan: export_schaechte",
                replacefun=lambda x: x.format(abfrage_s_and=self.abfrage_s_and)
            ):
                return
    ...
    def _export_speicher(self) -> None:
        ...
        if self.vorlage == "":
            ...
            if not self.db_qkan.sqltxt(
                'isy_export_select_speicher',
                "db_qkan: export_speicher",
                replacefun=lambda x: x.format(abfrage_s_and=self.abfrage_s_and)
            ):
                return
        ...
        if self.vorlage != "":
            ...
            if not self.db_qkan.sqltxt(
                'isy_export_select_speicher_vorlage',
                "db_qkan: export_schaechte",
                replacefun=lambda x: x.format(abfrage_s_and=self.abfrage_s_and)
            ):
                return
    ...
    def _export_haltungen(self) -> None:
        ...
        if self.vorlage == "":
            ...
            if not self.db_qkan.sqltxt(
                'isy_export_select_haltungen',
                "db_qkan: export_haltungen",
                replacefun=lambda x: x.format(abfrage_h_where=self.abfrage_h_where)
            ):
                return
    ...
    def _export_anschlussleitungen(self) -> None:
        ...
        if self.vorlage == "":
            ...
            if self.abfrage_h_where:
                if not self.db_qkan.sqltxt(
                    'isy_export_select_anschlussleitungen_with_haltung',
                    "db_qkan: export_anschlussleitungen",
                    replacefun=lambda x: x.format(abfrage_h_where=self.abfrage_h_where)
                ):
                    return
                ...
                if not self.db_qkan.sqltxt(
                    'isy_export_select_anschlussleitungen',
                    "db_qkan: export_anschlussleitungen"
                ):
                    return
    ...
    def _export_zustandsdaten_haltungen(self):
        if self.vorlage == "":
            ...
            if self.auswahl_zustand == "Stammdaten":
                ...
                if not self.db_qkan.sqltxt(
                    'isy_export_select_zustand_haltungen_stamm',
                    "db_qkan: export_zustandsdaten",
                    replacefun=lambda x: x.format(abfrage_h_and=self.abfrage_h_and)
                ):
                    return
                ...
                if not self.db_qkan.sqltxt(
                    'isy_export_select_zustand_haltungen_bewertet',
                    "db_qkan: export_zustandsdaten",
                    replacefun=lambda x: x.format(abfrage_h_and=self.abfrage_h_and)
                ):
                    return
                ...
                if not self.db_qkan.sqltxt(
                    'isy_export_select_zustand_haltungen_substanz',
                    "db_qkan: export_zustandsdaten",
                    replacefun=lambda x: x.format(abfrage_h_and=self.abfrage_h_and)
                ):
                    return
    ...
    def _export_zustandsdaten_anschlussleitungen(self):
        if self.vorlage == "":
            ...
            if self.auswahl_zustand == "Stammdaten":
                ...
                if self.abfrage_h_where:
                    if not self.db_qkan.sqltxt(
                        'isy_export_select_zustand_anschlussleitung_stamm_with_haltung',
                        "db_qkan: export_anschlussleitungen",
                        replacefun=lambda x: x.format(abfrage_h_where=self.abfrage_h_where)
                    ):
                        return
                    ...
                    if not self.db_qkan.sqltxt(
                        'isy_export_select_zustand_anschlussleitung_stamm',
                        "db_qkan: export_zustandsdaten"
                    ):
                        return
                ...
                if self.abfrage_h_where:
                    if not self.db_qkan.sqltxt(
                        'isy_export_select_zustand_anschlussleitung_bewertet_with_haltung',
                        "db_qkan: export_anschlussleitungen",
                        replacefun=lambda x: x.format(abfrage_h_where=self.abfrage_h_where)
                    ):
                        return
                    ...
                    if not self.db_qkan.sqltxt(
                        'isy_export_select_zustand_anschlussleitung_bewertet',
                        "db_qkan: export_zustandsdaten"
                    ):
                        return
    ...
    def _export_zustandsdaten_schaechte(self):
        if self.vorlage == "":
            ...
            if self.auswahl_zustand == "Stammdaten":
                ...
                if not self.db_qkan.sqltxt(
                    'isy_export_select_zustand_schaechte_stamm',
                    "db_qkan: export_zustandsdaten",
                    replacefun=lambda x: x.format(abfrage_s_and=self.abfrage_s_and)
                ):
                    return
                ...
                if not self.db_qkan.sqltxt(
                    'isy_export_select_zustand_schaechte_bewertet',
                    "db_qkan: export_zustandsdaten",
                    replacefun=lambda x: x.format(abfrage_s_and=self.abfrage_s_and)
                ):
                    return
