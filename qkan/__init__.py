...
class QKan:
    ...
    dbVersion = "3.4.6"  # "3.4.6" Version der QKan-Datenbank
    qgsVersion = "3.4.7"  # "3.4.7" Version des Projektes und der Projektdatei. Kann höher als die der QKan-Datenbank sein
